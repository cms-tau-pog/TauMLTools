...
private:
    ...
    void FillElectrons(const std::vector<const pat::Electron*>& electrons)
    {
        for(const pat::Electron* ele : electrons) {
            ...
            tauTuple().ele_e1x5.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->e1x5() : default_value);
            tauTuple().ele_e2x5Max.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->e2x5Max() : default_value);
            tauTuple().ele_e5x5.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->e5x5() : default_value);
            tauTuple().ele_r9.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->r9() : default_value);
            tauTuple().ele_hcalDepth1OverEcal.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->hcalDepth1OverEcal() : default_value);
            ...
            tauTuple().ele_eBottom.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->eBottom() : default_value);
            ...
            tauTuple().ele_full5x5_r9.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->full5x5_r9() : default_value);
            tauTuple().ele_full5x5_hcalDepth1OverEcal.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->full5x5_hcalDepth1OverEcal() : default_value);
            ...
            tauTuple().ele_full5x5_eBottom.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->full5x5_eBottom() : default_value);
            tauTuple().ele_full5x5_e2x5Left.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->full5x5_e2x5Left() : default_value);
            tauTuple().ele_full5x5_e2x5Right.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->full5x5_e2x5Right() : default_value);
            tauTuple().ele_full5x5_e2x5Top.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->full5x5_e2x5Top() : default_value);
            tauTuple().ele_full5x5_e2x5Bottom.push_back(!ele->hasUserFloat("hgcElectronID:sigmaUU") && ele->polarP4().pt() > 5 ? ele->full5x5_e2x5Bottom() : default_value);
