...
class GenJetFlavourTableProducerHLT : public edm::stream::EDProducer<> {
public:
  explicit GenJetFlavourTableProducerHLT(const edm::ParameterSet& iConfig)
  ...
  ~GenJetFlavourTableProducerHLT() override{};
...
void GenJetFlavourTableProducerHLT::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  auto tab = std::make_unique<nanoaod::FlatTable>(ncand, "GenJet", false, true);
  ...
  iEvent.put(std::move(tab), "GenJet");
}

#include "FWCore/Framework/interface/MakerMacros.h"
//define this as a plug-in
DEFINE_FWK_MODULE(GenJetFlavourTableProducerHLT);