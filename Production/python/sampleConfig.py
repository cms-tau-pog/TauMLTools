...
mcSampleTypes = set([ 'MC_16', 'MC_UL16', 'MC_UL16APV', 'MC_17', 'MC_UL17', 'MC_18', 'MC_UL18', 'Emb_16', 'Emb_17', 'Emb_18ABC', 'Emb_18D', 'MC_Phase2_113X', 'MC_Phase2_111X', 'MC_Phase2_110X','UL18', 'UL17','UL16','UL16APV', 'MC_RUN3_122X'])
...
def isRun2UL(sampleType):
    if sampleType not in periodDict:
        print ("ERROR: unknown sample type = '{}'".format(sampleType))
        sys.exit(1)
    return sampleType in ['MC_UL16', 'MC_UL16APV', 'MC_UL17', 'MC_UL18', 'RunUL2018', 'UL16', 'UL16APV', 'UL17', 'UL18']
