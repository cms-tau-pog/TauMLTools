...
parser.add_argument('--workArea', required=True, type=str, default="work_area", help="Work area")
...
parser.add_argument('--splitting', required=False, default="Automatic",
					help="suffix that will be added to each job name")
parser.add_argument('--unitsPerJob', required=False, type=int, default=1000,
