### NB: the interface of the Taco model with the training script is outdated.
###   The core model modules should be functional,
###   but the call() method should be adjusted for multiple input collections (see e.g. transformer.py)
