...
# python AdversarialGenerate_tf.py --n_batches=200 --scaling_cfg="../../configs/ShuffleMergeSpectral_trainingSamples-2_files_0_50.json" --save_path="/home/russell/tfdata/pathcommand/adv_blend" --training_cfg="../../configs/training_v1.yaml"
#adversarial ds:

save_path = args.save_path 
scaling_cfg = args.scaling_cfg 
training_cfg_path = args.training_cfg 
